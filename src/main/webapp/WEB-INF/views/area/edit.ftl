[@override name="title"]区域管理 - 区域修改[/@override]
...
<div class="row">
    <div class="col-lg-8">
        <form class="form-horizontal" action="/area/edit.htm" method="post" data-parsley-validate>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="name" name="name"
                           value="${area.name!command.name}" placeholder="输入区域名称"
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="shortName" name="shortName"
                           value="${area.shortName!command.shortName}" placeholder="输入区域简称"
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="longitude" name="longitude"
                           value="${area.longitude!command.longitude}" placeholder="输入区域经度"
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="latitude" name="latitude"
                           value="${area.latitude!command.latitude}" placeholder="输入区域纬度"
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="sort" name="sort"
                           value="${area.sort!command.sort}" placeholder="输入区域排序值"
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <select class="form-control" name="level" id="level"
                            ...
                            data-parsley-trigger="change">
                        [#assign level = (area.level!command.level)?default("") /]
                        <option>请选择</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <select class="form-control" name="status" id="status"
                            ...
                            data-parsley-trigger="change">
                        [#assign status = (area.status!command.status)?default("") /]
