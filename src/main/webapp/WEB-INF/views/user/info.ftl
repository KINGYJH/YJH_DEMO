    ...
    <div class="col-lg-12">
        <ul class="contract-show">
            ...
            <li>
                ...
                <div class="col-md-8 contract-box">[@mc.dateShow user.updateDate/]</div>
            </li>
            <li>
            ...
            <div>
                <div class="col-sm-offset-6 col-sm-12">
                    <a href="[@spring.url '/user/create.htm' /]" class="btn btn-success">再创建一个</a>
                    <a href="[@spring.url '/user/pagination.htm' /]" class="btn btn-default">返回列表</a>
                </div>
            </div>
        </ul>
    </div>
